...
CREATE TABLE `apartment` (
  ...
  apartment_updated_at timestamp DEFAULT CURRENT_TIMESTAMP,
);
...
CREATE TABLE `user_problem` (
  ...
  user_problem_updated_at timestamp DEFAULT CURRENT_TIMESTAMP,
);
...
CREATE TABLE `user_invoice` (
  ...
  user_invoice_updated_at timestamp DEFAULT CURRENT_TIMESTAMP,
);
...
CREATE TABLE `apartment_rental` (
  ...
  apartment_rental_updated_at timestamp DEFAULT CURRENT_TIMESTAMP,
);
...
CREATE TABLE `service` (
  ...
  apartment_service_updated_at timestamp DEFAULT CURRENT_TIMESTAMP,
);
...
CREATE TABLE `user_planning` (
  ...
  user_planning_updated_at timestamp DEFAULT CURRENT_TIMESTAMP,
);
...
CREATE TABLE `apartment_employee` (
  ...
  apartment_employee_updated_at timestamp DEFAULT CURRENT_TIMESTAMP,
);
...
CREATE TABLE `apartment_check` (
  ...
  apartment_check_updated_at timestamp DEFAULT CURRENT_TIMESTAMP,
);
...
CREATE TABLE `user_review` (
  ...
  user_review_updated_at timestamp DEFAULT CURRENT_TIMESTAMP,
);
...
CREATE TABLE `employee_report` (
  ...
  employee_report_updated_at timestamp DEFAULT CURRENT_TIMESTAMP,
);
